...
<p class="Stile1">{company_name}</p>
	<div class="statusorder">
    	<div class="boxstatusorder"><p class="Stile1"><?php echo JText::_('VRIORDERNUMBER'); ?>: {order_id}</div>
    	{confirmnumb_delimiter}<div class="boxstatusorder"><span class="Stile1"><?php echo JText::_('VRICONFIRMATIONNUMBER'); ?>: {confirmnumb}</span></div>{/confirmnumb_delimiter}
    ...
    <div class="hiremainbox">
        <div class="hireitem clearfix">
            <div class="hiredate">
                ...
                {if_pickup_location}<p><span class="Stile12"><?php echo JText::_('VRRITIROITEM'); ?>: </span>
            ...
            <div class="hiredate">
                ...
                {if_dropoff_location}<p><span class="Stile12"><?php echo JText::_('VRRETURNITEMORD'); ?>:</span>
                <span class="Stile9">{dropoff_location}</span></p>{/if_dropoff_location}
            </div>
        </div>
        <div class="hireorderdetail">
        	<p><span class="Stile1"><?php echo JText::_('VRIORDERDETAILS'); ?>:</span></p>
            {order_details}
