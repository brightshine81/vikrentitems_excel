...
class VikRentItemsTranslator {
	...
	public function getIniFiles() {
		...
		return array(
			'com_vikrentitems_front' => array('path' => JPATH_SITE.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentitems.ini'),
			'com_vikrentitems_admin' => array('path' => JPATH_ADMINISTRATOR.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentitems.ini'),
			'com_vikrentitems_admin_sys' => array('path' => JPATH_ADMINISTRATOR.DS.'language'.DS.'en-GB'.DS.'en-GB.com_vikrentitems.sys.ini'),
			'mod_vikrentitems_search' => array('path' => JPATH_SITE.DS.'language'.DS.'en-GB'.DS.'en-GB.mod_vikrentitems_search.ini')
		);
	}
