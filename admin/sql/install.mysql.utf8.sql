...
INSERT INTO `#__vikrentitems_config` (`param`,`setting`) VALUES ('fronttitletag','h3');
INSERT INTO `#__vikrentitems_config` (`param`,`setting`) VALUES ('fronttitletagclass','');
INSERT INTO `#__vikrentitems_config` (`param`,`setting`) VALUES ('searchbtnclass','button');
...
INSERT INTO `#__vikrentitems_texts` (`param`,`exp`,`setting`) VALUES ('searchbtnval','Search Button Text','Search');
...
INSERT INTO `#__vikrentitems_custfields` (`name`,`type`,`choose`,`required`,`ordering`,`isemail`,`poplink`,`isnominative`,`isphone`,`flag`) VALUES ('VBCUSTOMERCOMPANY','text','','0','10','0','', 0, 0, 'company');
INSERT INTO `#__vikrentitems_custfields` (`name`,`type`,`choose`,`required`,`ordering`,`isemail`,`poplink`,`isnominative`,`isphone`,`flag`) VALUES ('VBCUSTOMERCOMPANYVAT','text','','0','11','0','', 0, 0, 'vat');
