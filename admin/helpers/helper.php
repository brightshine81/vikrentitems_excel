...
class VikRentItemsHelper {
	...
	public static function printHeader($highlight="") {
		...
		<div class="vri-menu-container">
			<div class="vri-menu-left"><img src="<?php echo VRI_ADMIN_URI; ?>vikrentitems.png" alt="VikRentItems Logo" /></div>
			<div class="vri-menu-right">
				<ul class="vri-menu-ul">
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-truck"></i> <a href="javascript: void(0);"><?php echo JText::_('VRMENUONE'); ?></a></span>
						<ul class="vri-submenu-ul">
						<?php
						if ($vri_auth_prices) {
							?>
							<li><span class="<?php echo ($highlight=="2" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=iva"><?php echo JText::_('VRMENUNINE'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="1" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=prices"><?php echo JText::_('VRMENUFIVE'); ?></a></span></li>
							<?php
						}
						if ($vri_auth_gsettings) {
							?>
							<li><span class="<?php echo ($highlight=="3" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=places"><?php echo JText::_('VRMENUTENTHREE'); ?></a></span></li>
							<?php
						}
						if ($vri_auth_prices) {
							?>
							<li><span class="<?php echo ($highlight=="timeslots" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=timeslots"><?php echo JText::_('VRMENUTIMESLOTS'); ?></a></span></li>
							<?php
						}
						?>
						</ul>
					...
					?>
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-stack"></i> <a href="javascript: void(0);"><?php echo JText::_('VRMENUTWO'); ?></a></span>
						<ul class="vri-submenu-ul">
							<li><span class="<?php echo ($highlight=="4" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=categories"><?php echo JText::_('VRMENUSIX'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="6" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=optionals"><?php echo JText::_('VRMENUTENFIVE'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="5" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=carat"><?php echo JText::_('VRMENUTENFOUR'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="7" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=items"><?php echo JText::_('VRMENUTEN'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="relations" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=relations"><?php echo JText::_('VRMENURELATIONS'); ?></a></span></li>
						</ul>
					</li>
					<?php
					}
					?>
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-credit-card"></i> <a href="javascript: void(0);"><?php echo JText::_('VRMENUTHREE'); ?></a></span>
						<ul class="vri-submenu-ul">
                            <li><span class="<?php echo ($highlight=="8" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=orders"><?php echo JText::_('VRMENUSEVEN'); ?></a></span></li>
                        <?php
						if ($vri_auth_orders) {
						?>
							<li><span class="<?php echo ($highlight=="19" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=calendar"><?php echo JText::_('VRIMENUQUICKRES'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="15" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=overv"><?php echo JText::_('VRMENUTENNINE'); ?></a></span></li>
						<?php
						}
						?>
							<li><span class="<?php echo ($highlight=="18" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems"><?php echo JText::_('VRIMENUDASHBOARD'); ?></a></span></li>
						</ul>
					</li>
					<?php
					...
					?>
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-users"></i> <a href="javascript: void(0);"><?php echo JText::_('VRIMENUMANAGEMENT'); ?></a></span>
						<ul class="vri-submenu-ul">
							<li><span class="<?php echo ($highlight=="customers" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=customers"><?php echo JText::_('VRIMENUCUSTOMERS'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="17" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=coupons"><?php echo JText::_('VRIMENUCOUPONS'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="10" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=stats"><?php echo JText::_('VRMENUEIGHT'); ?></a></span></li>
						</ul>
					</li>
					<?php
					}
					...
					?>
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-calculator"></i> <a href="javascript: void(0);"><?php echo JText::_('VRIMENUFARES'); ?></a></span>
						<ul class="vri-submenu-ul">
							<li><span class="<?php echo ($highlight=="fares" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=tariffs"><?php echo JText::_('VRIMENUPRICESTABLE'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="13" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=seasons"><?php echo JText::_('VRMENUTENSEVEN'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="12" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=locfees"><?php echo JText::_('VRMENUTENSIX'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="discounts" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=discounts"><?php echo JText::_('VRIMENUDISCOUNTS'); ?></a></span></li>
						</ul>
					</li>
					<?php
					}
					...
					?>
					<li class="vri-menu-parent-li">
						<span><i class="vriicn-cogs"></i> <a href="javascript: void(0);"><?php echo JText::_('VRMENUFOUR'); ?></a></span>
						<ul class="vri-submenu-ul">
							<li><span class="<?php echo ($highlight=="11" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=config"><?php echo JText::_('VRMENUTWELVE'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="20" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=translations"><?php echo JText::_('VRMENUTRANSLATIONS'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="14" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=payments"><?php echo JText::_('VRMENUTENEIGHT'); ?></a></span></li>
							<li><span class="<?php echo ($highlight=="16" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=customf"><?php echo JText::_('VRMENUTENTEN'); ?></a></span></li>
						</ul>
					</li>
					<?php
					}
				...
				if ($highlight == '18' || $highlight == '11') {
					...
					if (count($callable) && $callable[0]) {
						...
						?>
						<button type="button" id="vik-update-btn" onclick="<?php echo count($result) && $result[0] && $result[0]->response->compare == 1 ? 'document.location.href=\'index.php?option=com_vikrentitems&task=updateprogram\'' : 'checkVersion(this);'; ?>">
							<i class="vriicn-cloud"></i> 
						...
						function checkVersion(button) {
							...
							jQuery.ajax({
								type: 'POST',
								url: 'index.php?option=com_vikrentitems&task=checkversion&tmpl=component',
								data: {}
							}).done(function(resp){
								...
								if (obj.status == 1 && obj.response.status == 1) {
									...
									if (obj.response.compare == 1) {
										jQuery(button).attr('onclick', 'document.location.href="index.php?option=com_vikrentitems&task=updateprogram"');
									}
								}
							}).fail(function(resp){
								console.log(resp);
		...
		function vriDetectMenuChange(e) {
			...
			if ((e.which == 77 || e.keyCode == 77) && e.altKey) {
				...
				document.cookie = "vriMenuType="+vri_menu_type+"; expires=" + nd.toUTCString() + "; path=/";
			}
		}
	...
	public static function printFooter() {
		echo '<br clear="all" />' . '<div id="hmfooter">' . JText::sprintf('VRIVERSION', E4J_SOFTWARE_VERSION) . ' <a href="https://extensionsforjoomla.com/">e4j - Extensionsforjoomla.com</a></div>';
	}
