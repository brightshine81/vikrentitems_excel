...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	for ($i = 0, $n = count($rows); $i < $n; $i++) {
		...
		<tr class="row<?php echo $k; ?>">
			...
			<td><a href="index.php?option=com_vikrentitems&amp;task=editpayment&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a></td>
			<td><?php echo $row['file']; ?></td>
			<td><?php echo strip_tags($row['note']); ?></td>
			<td class="center"><?php echo $saycharge; ?></td>
			<td class="center"><?php echo intval($row['published']) == 1 ? "<i class=\"fa fa-check vri-icn-img\" style=\"color: #099909;\"></i>" : "<i class=\"fa fa-times-circle vri-icn-img\" style=\"color: #ff0000;\"></i>"; ?></td>
        </tr>  
		<?php
		$k = 1 - $k;
	}
