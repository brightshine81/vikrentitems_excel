...
class VikRentItemsViewPayments extends JViewVikRentItems {
	...
	function display($tpl = null) {
		...
		$q = "SELECT SQL_CALC_FOUND_ROWS * FROM `#__vikrentitems_gpayments` ORDER BY `#__vikrentitems_gpayments`.`name` ASC";
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINPAYMENTSTITLE'), 'vikrentitems');
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removepayments', JText::_('VRMAINPAYMENTSDEL'));
			JToolBarHelper::spacer();
		}
	}
