...
class VikRentItemsViewManagetimeslot extends JViewVikRentItems {
	...
	protected function addToolBar() {
		...
		if (!empty($cid[0])) {
			//edit
			JToolBarHelper::title(JText::_('VRMAINTIMESLOTTITLEEDIT'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.edit', 'com_vikrentitems')) {
				JToolBarHelper::save( 'updatetimeslot', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
			}
			JToolBarHelper::cancel( 'canceltimeslot', JText::_('VRANNULLA'));
			JToolBarHelper::spacer();
		} else {
			//new
			JToolBarHelper::title(JText::_('VRMAINTIMESLOTTITLENEW'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.create', 'com_vikrentitems')) {
				JToolBarHelper::save( 'createtimeslot', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
			}
			JToolBarHelper::cancel( 'canceltimeslot', JText::_('VRANNULLA'));
			JToolBarHelper::spacer();
