...
class VikRentItemsViewCoupons extends JViewVikRentItems {
	...
	function display($tpl = null) {
		...
		$q = "SELECT SQL_CALC_FOUND_ROWS * FROM `#__vikrentitems_coupons` ORDER BY `#__vikrentitems_coupons`.`code` ASC";
	...
	protected function addToolBar() {
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removecoupons', JText::_('VRMAINCOUPONDEL'));
			JToolBarHelper::spacer();
		}
	}
