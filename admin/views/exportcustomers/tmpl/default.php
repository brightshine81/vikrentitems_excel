...
$wselcountries = '<select name="country"><option value="">'.JText::_('VRIANYCOUNTRY').'</option>'."\n";
...
if (count($cid) > 0 && !empty($cid[0])) {
	...
	?>
	<h4><?php echo JText::_('VRICUSTOMEREXPALL'); ?></h4>
	<div class="vri-export-customer-entry">
		<?php echo $vri_app->getCalendar('', 'fromdate', 'fromdate', $nowdf, array('class'=>'', 'size'=>'10', 'maxlength'=>'19', 'placeholder' => JText::_('VREXPORTONE'), 'todayBtn' => 'true')); ?>
		&nbsp;
		<?php echo $vri_app->getCalendar('', 'todate', 'todate', $nowdf, array('class'=>'', 'size'=>'10', 'maxlength'=>'19', 'placeholder' => JText::_('VREXPORTTWO'), 'todayBtn' => 'true')); ?>
		&nbsp;
		<select name="datefilt">
			<option value="1"><?php echo JText::_('VRPCHOOSEBUSYORDATE'); ?></option>
			<option value="2"><?php echo JText::_('VRIEXPCSVPICK'); ?></option>
			<option value="3"><?php echo JText::_('VRIEXPCSVDROP'); ?></option>
		</select>
	</div>
	<div class="vri-export-customer-entry">
	<?php
...
?>
	<div class="vri-export-customer-entry">
		<span>
			<label for="donotes"><?php echo JText::_('VRICUSTOMEREXPNOTES'); ?></label>
		</span>
		<input type="checkbox" name="notes" value="1" id="donotes" />
	</div>
	<div class="vri-export-customer-entry">
		<span>
			<label for="dopin"><?php echo JText::_('VRICUSTOMEREXPPIN'); ?></label>
		</span>
		<input type="checkbox" name="pin" value="1" id="dopin" />
	</div>
	<div class="vri-export-customer-entry">
		<span>
			<label for="doscanimg"><?php echo JText::_('VRICUSTOMEREXPSCANIMG'); ?></label>
		</span>
