...
class VikRentItemsViewChoosebusy extends JViewVikRentItems {
	...
	protected function addToolBar() {
		...
		JToolBarHelper::title(JText::_('VRMAINCHOOSEBUSY')." ".$cname.", ".date('Y-M-d', $pts), 'vikrentitems');
