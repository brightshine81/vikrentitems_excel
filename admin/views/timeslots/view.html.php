...
class VikRentItemsViewTimeslots extends JViewVikRentItems {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINTIMESLOTSTITLE'), 'vikrentitems');
		if (JFactory::getUser()->authorise('core.create', 'com_vikrentitems')) {
			JToolBarHelper::addNew('newtimeslot', JText::_('VRMAINTIMESLOTSNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentitems')) {
			JToolBarHelper::editList('edittimeslot', JText::_('VRMAINTIMESLOTSEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removetimeslots', JText::_('VRMAINTIMESLOTSDEL'));
			JToolBarHelper::spacer();
		}
	}
