...
if (empty($rows)) {
	?>
	<p class="warn"><?php echo JText::_('VRINOTIMESLOTS'); ?></p>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	<tr>
		...
		<th class="title left" width="200" align="left"><?php echo JText::_( 'VRPSHOWTIMESLOTSONE' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWTIMESLOTSTWO' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWTIMESLOTSTHREE' ); ?></th>
		<th class="title center" width="150"><?php echo JText::_( 'VRITIMESLOTDAYS' ); ?></th>
		<th class="title center" width="250"><?php echo JText::_( 'VRPSHOWTIMESLOTSFOUR' ); ?></th>
	</tr>
	</thead>
	<?php
	$k = 0;
