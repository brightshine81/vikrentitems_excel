...
class VikRentItemsViewLocfees extends JViewVikRentItems {
	...
	function display($tpl = null) {
		...
		$q = "SELECT SQL_CALC_FOUND_ROWS * FROM `#__vikrentitems_locfees` ORDER BY `#__vikrentitems_locfees`.`id` DESC";
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINLOCFEESTITLE'), 'vikrentitems');
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removelocfee', JText::_('VRMAINLOCFEEDEL'));
			JToolBarHelper::spacer();
		}
	}
