...
$fprice = "<div class=\"vri-fares-tabs\"><div class=\"dailyprices\"><a href=\"index.php?option=com_vikrentitems&task=tariffs&cid[]=".$iditem."\">".JText::_('VRIDAILYFARES')."</a></div><div class=\"hourscharges\"><a href=\"index.php?option=com_vikrentitems&task=hourscharges&cid[]=".$iditem."\">".JText::_('VRIHOURSCHARGES')."</a></div><div class=\"hourlypricesactive\">".JText::_('VRIHOURLYFARES')."</div></div>\n";
if (empty($prices)) {
	...
	$fprice .= "<span class=\"vri-ratestable-lbl\">".JText::_('VRIHOURLYPRICES').": </span><table>\n";
	...
	$fprice .= "<tr><td colspan=\"".$colsp."\" align=\"right\"><input type=\"submit\" class=\"vrisubmitfares btn btn-large btn-success\" name=\"newdispcost\" value=\"".JText::_('VRINSERT')."\"/></td></tr></table></div><input type=\"hidden\" name=\"cid[]\" value=\"".$iditem."\"/><input type=\"hidden\" name=\"task\" value=\"tariffshours\"/></form>";
}
...
$chitemsel .= "</select>\n";
$chitemf = "<form name=\"vrichitem\" method=\"post\" action=\"index.php?option=com_vikrentitems\"><input type=\"hidden\" name=\"task\" value=\"tariffshours\"/>".$chitemsel."</form>";
