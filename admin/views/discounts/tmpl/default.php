...
if (empty($rows)) {
	?>
	<p class="warn"><?php echo JText::_('VRINODISCOUNTS'); ?></p>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	<tr>
		...
		<th class="title left" width="150"><?php echo JText::_( 'VRPSHOWDISCOUNTSONE' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWDISCOUNTSTWO' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWDISCOUNTSTHREE' ); ?></th>
		<th class="title center" width="250"><?php echo JText::_( 'VRPSHOWDISCOUNTSFOUR' ); ?></th>
	</tr>
	</thead>
	<?php
