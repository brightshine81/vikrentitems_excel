...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	<tr>
		...
		<th class="title center" width="100" align="center"><?php echo JText::_( 'VRIPLACELAT' ); ?></th>
		<th class="title center" width="100" align="center"><?php echo JText::_( 'VRIPLACELNG' ); ?></th>
		<th class="title left" width="150"><?php echo JText::_( 'VRIPLACEDESCR' ); ?></th>
		<th class="title center" width="150" align="center"><?php echo JText::_( 'VRIPLACEOPENTIME' ); ?></th>
	</tr>
	</thead>
	<?php
