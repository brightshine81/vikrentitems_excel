...
class VikRentItemsViewCustomf extends JViewVikRentItems {
	...
	function display($tpl = null) {
		...
		$q = "SELECT SQL_CALC_FOUND_ROWS * FROM `#__vikrentitems_custfields` ORDER BY `#__vikrentitems_custfields`.`ordering` ASC";
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINCUSTOMFTITLE'), 'vikrentitems');
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removecustomf', JText::_('VRMAINCUSTOMFDEL'));
			JToolBarHelper::spacer();
		}
	}
