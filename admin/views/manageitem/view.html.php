...
class VikRentItemsViewManageitem extends JViewVikRentItems {
	...
	protected function addToolBar() {
		...
		if (!empty($cid[0])) {
			//edit
			JToolBarHelper::title(JText::_('VRMAINITEMTITLEEDIT'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.edit', 'com_vikrentitems')) {
				JToolBarHelper::apply( 'updateitemapply', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
				JToolBarHelper::save( 'updateitem', JText::_('VRSAVECLOSE'));
				JToolBarHelper::spacer();
			}
			...
			//new
			JToolBarHelper::title(JText::_('VRMAINITEMTITLENEW'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.create', 'com_vikrentitems')) {
				JToolBarHelper::save( 'createitem', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
			}
			JToolBarHelper::cancel( 'cancel', JText::_('VRANNULLA'));
			JToolBarHelper::spacer();
