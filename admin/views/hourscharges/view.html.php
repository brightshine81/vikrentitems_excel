...
class VikRentItemsViewHourscharges extends JViewVikRentItems {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINTARIFFETITLE'), 'vikrentitems');
		JToolBarHelper::save( 'cancel', JText::_('VRMAINTARIFFEBACK'));
		JToolBarHelper::spacer();
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentitems')) {
			JToolBarHelper::deleteList(JText::_('VRIDELCONFIRM'), 'removehourscharges', JText::_('VRMAINTARIFFEDEL'));
			JToolBarHelper::spacer();
		}
	}
