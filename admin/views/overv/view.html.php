...
class VikRentItemsViewOverv extends JViewVikRentItems {
	...
	function display($tpl = null) {
		...
		if ($dbo->getNumRows() > 0) {
			...
			VikError::raiseWarning('', JText::_('VROVERVIEWNOITEMS'));
		...
		if ($pmnum > 0) {
			$cookie->set('vriOvwMnum', $pmnum, (time() + (86400 * 365)), '/');
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VRMAINOVERVIEWTITLE'), 'vikrentitems');
