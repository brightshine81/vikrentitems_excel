...
class VikRentItemsViewManagerelation extends JViewVikRentItems {
	...
	protected function addToolBar() {
		...
		if (!empty($cid[0])) {
			//edit
			JToolBarHelper::title(JText::_('VRMAINRELATIONTITLEEDIT'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.edit', 'com_vikrentitems')) {
				JToolBarHelper::save( 'updaterelation', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
			}
			JToolBarHelper::cancel( 'cancelrelation', JText::_('VRANNULLA'));
			JToolBarHelper::spacer();
		} else {
			//new
			JToolBarHelper::title(JText::_('VRMAINRELATIONTITLENEW'), 'vikrentitems');
			if (JFactory::getUser()->authorise('core.create', 'com_vikrentitems')) {
				JToolBarHelper::save( 'createrelation', JText::_('VRSAVE'));
				JToolBarHelper::spacer();
			}
			JToolBarHelper::cancel( 'cancelrelation', JText::_('VRANNULLA'));
			JToolBarHelper::spacer();
