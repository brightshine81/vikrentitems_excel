...
if (empty($rows)) {
	?>
	<p class="warn"><?php echo JText::_('VRINORELATIONS'); ?></p>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped">
	...
	<tr>
		...
		<th class="title left" width="200" align="left"><?php echo JText::_( 'VRPSHOWRELATIONSONE' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWRELATIONSTWO' ); ?></th>
		<th class="title center" width="100"><?php echo JText::_( 'VRPSHOWRELATIONSTHREE' ); ?></th>
	</tr>
	</thead>
	<?php
	$k = 0;
