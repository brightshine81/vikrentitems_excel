...
if (count($locations) > 0) {
	...
	$document->addScript('https://code.jquery.com/jquery-latest.min.js');
	...
	function vriSetLocOpenTimeFrame(loc, where) {
		jQuery.ajax({
			type: "POST",
			url: "<?php echo JRoute::_('index.php?option=com_vikrentitems&task=ajaxlocopentime&tmpl=component'); ?>",
